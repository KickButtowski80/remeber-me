<template>
  ...
  >
    <defs>
      <clipPath id="clip-Chr_9"><rect height="512" width="512" /></clipPath>
    </defs>
    <g clip-path="url(#clip-Chr_9)" data-name="Chr 9" id="Chr_9">
      ...
      <g data-name="Character 9" id="Character_9">
        ...
        <g data-name="4. Face Body" id="_4._Face_Body">
          ...
          />
          <path
            d="M34,9.867c17.25,0,35-2.48,35,6.633S53.054,39.464,34,39.464,0,25.613,0,16.5,16.75,9.867,34,9.867Z"
            data-name="Path 3100"
            fill="#fff"
            id="Path_3100"
            transform="translate(222 249)"
          />
        </g>
        ...
        <path
          d="M127,0c70.14,0,80.132,38.832,114.544,26.924,16.931-5.859,9.579,37.916-22.785,64.843-15.046,12.519-33.287,24.806-80.366,38.466C81.814,146.649,0,165.367,0,127A127,127,0,0,1,127,0Z"
          data-name="1. Front Hair"
          fill="#463929"
          id="_1._Front_Hair"
          transform="matrix(0.996, 0.087, -0.087, 0.996, 141.941, -10.667)"
        />
      </g>
    </g>
  </svg>
